  ...
  return (
    <section className="py-16 sm:py-20 bg-brand-950 border-t border-brand-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-6 border-t border-brand-900 flex flex-col md:flex-row md:items-center justify-between gap-6">
          {/* Client Logos */}
          ...
          {/* Rating Block */}
          <div className="flex items-center gap-3 shrink-0 border-l border-brand-800 pl-6 hidden md:flex">
            ...
            <div>
              <p className="text-xs font-bold text-white leading-tight">4.9/5</p>
              <p className="text-[10px] text-brand-400 leading-tight">from 500+ happy customers</p>
            </div>
          </div>
        </div>
      </div>
