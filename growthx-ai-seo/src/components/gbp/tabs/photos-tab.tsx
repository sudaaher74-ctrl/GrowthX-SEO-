  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <h2 className="text-sm font-bold text-brand-950">Photos data not available</h2>
        <p className="text-xs text-brand-500 max-w-md leading-relaxed">
          {businessName ? `${businessName}'s` : "This profile's"} photo library, photo view counts, and category
          breakdown are not fetched by GrowthX yet — there is no connected data source for them. Manage photos
          directly on Google, or ask GrowthX to add a photos integration.
        </p>
