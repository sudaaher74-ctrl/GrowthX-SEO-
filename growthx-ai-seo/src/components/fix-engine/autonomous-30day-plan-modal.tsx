            ...
            <div className="flex items-center gap-2">
              ...
              {currentWeekTasks.length > 0 && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-950 hover:bg-black text-white text-xs font-bold transition shadow-xs cursor-pointer"
                >
                  <Sparkles size={12} />
            ...
            {allTasks.length === 0 ? (
              <div className="py-12 text-center text-brand-500 space-y-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-slate-950 px-4 py-2 text-xs font-semibold text-white hover:bg-black disabled:opacity-50 transition shadow-xs cursor-pointer"
                >
                  ...
                  {task.status === "COMPLETED" ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-[10.5px] font-bold text-slate-900 hover:text-black hover:underline cursor-pointer"
                      >
                        <Play size={11} />
