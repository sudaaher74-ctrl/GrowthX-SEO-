...
const variantStyles = {
  primary: "bg-black text-white shadow-[0_1px_2px_rgba(0,0,0,0.1),0_0_0_1px_rgba(0,0,0,0.05)] hover:bg-gray-900",
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900/10 focus-visible:ring-offset-2",
