                      ...
                      <Panel title="Executive Business Summary & Positioning" subtitle="High-level AI-generated marketing analysis">
                        <div className="p-5 space-y-5 text-sm text-[var(--text-primary)]">
                          <div className="p-4 rounded-xl border border-[var(--border-color)] bg-[var(--surface-2)]">
                            <h4 className="font-bold text-xs uppercase tracking-wider text-blue-600 mb-1.5">Business Overview</h4>
                        ...
                        <tbody>
                          {strategyContent.seoRoadmap.map((item, i) => (
                            <Tr key={i}>
                              ...
                              <Td><span className="text-[12px] font-semibold text-emerald-600">{item.impact ?? item.expectedImpact ?? "—"}</span></Td>
                            </Tr>
                          ))}
                        </tbody>
                      </Table>
                        ...
                        <tbody>
                          {campaigns.map((campaign) => (
                            <Tr key={campaign.id}>
                              ...
                              <Td><span className="text-[13px] font-medium text-emerald-600">{campaign.linkCount}</span></Td>
                            </Tr>
                          ))}
                        </tbody>
                      </Table>
