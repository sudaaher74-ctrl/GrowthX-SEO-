    ...
    <div className="w-full max-w-md mx-auto my-auto py-6 sm:py-8">
      ...
      <div className="space-y-2.5">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-brand-800 bg-brand-900/90 hover:bg-brand-900 text-xs sm:text-sm font-semibold text-brand-200 shadow-sm transition-all cursor-pointer"
        >
