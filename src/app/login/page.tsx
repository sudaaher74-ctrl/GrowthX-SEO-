  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-3/4 left-1/2 w-64 h-64 rounded-full opacity-10 blur-3xl" style={{ background: "radial-gradient(circle, #06b6d4, transparent)" }}/>
      </div>
        ...
        <div className="glass-strong rounded-2xl p-8">
          ...
          <div className="space-y-3">
            <input type="email" placeholder="Email address" defaultValue="sudarshan@growthx.in"
              className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-400 transition-base"/>
          ...
          <p className="text-center text-sm text-slate-500 mt-4">
            ...
            <Link href="/register" className="text-indigo-400 cursor-pointer hover:text-indigo-300 font-medium">Start free trial</Link>
          </p>
        </div>
